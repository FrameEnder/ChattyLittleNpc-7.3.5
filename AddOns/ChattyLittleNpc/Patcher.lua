...
PlaySoundFile = function(soundPath, ...)
  -- Capture original returns
  local results = { orgPlaySoundFile(soundPath, ...) }
  -- The soundHandle is always the last return
  local soundHandle = results[#results]
  if soundHandle then
